...
<body>
  ...
  <div class="no-visto" id="instituto">
    ...
    <ul class="no-visto-lista" id="instituto-lista">
      <li>
        <a href="app/instituto/mensaje.php">
          MENSAJE DEL DIRECTOR
        </a>
      </li>
      <li>
        <a href="app/instituto/directorio.php">          
          DIRECTORIO TELEFÓNICO
        </a>
      </li>
      <li>
        <a href="app/instituto/filosofia.php">
          FILOSOFÍA 
        </a>
      </li>
      <li>
  ...
  <div class="no-visto" id="ofertas">
    ...
    <ul class="no-visto-lista" id="instituto-lista-oferta">
      <li>
        <a href="app/oferta/sistemas.php">
          INGENIERÍA EN SISTEMAS
        </a>
      </li>
      <li>
        <a href="app/oferta/agronomia.php">          
          INGENIERÍA EN AGRONOMÍA
        </a>
      </li>
      <li>
        <a href="app/oferta/forestal.php">
          INGENIERÍA FORESTAL
        </a>
      </li>
      <li>
        <a href="app/oferta/desarrollo.php">
  ...
  <div class="no-visto" id="centroServicio">
    ...
    <ul class="no-visto-lista" id="instituto-lista-centro">
      ...
      <li>
        <a href="app/centro/calendario.php">
          CALENDARIO ESCOLAR
        </a>
      </li>      
      <li>
      ...
      <li>
        <a href="app/centro/noticias.php">
          NOTICIAS
        </a>
      </li>
    </ul>
  ...
  <script type="text/javascript">
    ...
    $(function() {
      $(".rslides").responsiveSlides({
        ...
        nextText: "Adelante",       // String: Text for the "next" button
