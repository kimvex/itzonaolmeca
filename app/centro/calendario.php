...
<body>
  ...
  <section class="cuerpo-calendario">  
    <span class="ir-arriba"></span>
    <h3>Calendario Escolar</h3>
    <h4>Período Enero-Julio 2016</h4>
    <nav class="meses">
      <li class="li-meses" id="enero">Enero</li>
      <li class="li-meses" id="febrero">Febrero</li>
      <li class="li-meses" id="marzo">Marzo</li>
      <li class="li-meses" id="abril">Abril</li>
      <li class="li-meses" id="mayo">Mayo</li>
      <li class="li-meses" id="junio">Junio</li>
      <li class="li-meses" id="julio">Julio</li>
    </nav>
