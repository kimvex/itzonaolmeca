...
<body>
  ...
  <section class="cuerpo-noticias-informacion"> 
    ...
    <p>Firma de convenio de colaboración entre la comisión nacional para el desarrollo de los pueblos indígenas (CDI Tabasco) y el Instituto Tecnológico de la Zona Olmeca (ITZO), en el marco del programa para el mejoramiento de la producción y productividad indigena (PROIN) 2015.</p>
  </section>
  <footer class="pies">
    <ul class="pies-lista">
      <li class="tamano">
