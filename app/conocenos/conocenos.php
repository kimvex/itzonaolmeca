...
<body>
  ...
  <div class="galeria">   
    <section id="least">
        ...
        <video src="../../assets/img/conocenos/video/Video-ITZO.mp4" poster="../../assets/img/FondoF.jpg" controls>
          
        </video>
        <div class="least-preview"></div>
        <ul class="least-gallery">
            <li>
                <a href="../../assets/img/conocenos/imagenes/itzo-1.jpg" title="Instituto Tecnológico de la Zona Olmeca">
                    <img src="../../assets/img/conocenos/imagenes/itzo-1.jpg" alt="Instituto Tecnológico de la Zona Olmeca" />
                </a>
            </li>            
        </ul>
    </section>
