...
<body>
  ...
  <section class="cuerpo-organigrama">  
    <h3>Organigrama</h3>
    <article class="organigrama">
<!--       <div class="director-organigrama">
        <img src="../../assets/img/javier.png">
        <p class="nombre-organigrama">
          M.C. José Javier Peralta Cosgaya
        </p>
        <p class="puesto-organigrama">Director</p>
      </div> -->
      <embed class="pdf-organigrama" src="../../assets/pdf/organigrama.pdf" width="850px" height="600px" type="application/pdf">
    </article>
