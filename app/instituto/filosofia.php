...
<body>
  ...
  <section class="cuerpo-filosofia">  
    <span class="ir-arriba icon-arrow-up"></span>
    <article class="filosofia">
      <h3 class="titulo-filosofia">Filosofia</h3>
      <img src="../../assets/img/segundo.png">
      <h3 class="subtitulo-filosofia">Visión</h3>
      <p>
        Ser una institución educativa de excelencia que genere, aplique y transfiera conocimientos en el sureste mexicano.
      </p>
      <h3 class="subtitulo-filosofia">Misión</h3>
      <p>Ofrecer servicios educativos de calidad que contribuyan en la formación integral de profesionistas competentes, sustentados en la responsabilidad, trabajo en equipo, liderazgo y equidad, que promuevan el desarrollo de la sociedad.</p>
      <h3 class="subtitulo-filosofia">Valores</h3>
      <p>
        • Responsabilidad
